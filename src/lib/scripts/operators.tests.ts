// FILEPATH: /d:/boulot/app-node/idbq/src/lib/scripts/operators.test.ts
...
describe('Operators.filters', () => {
    ...
    it('filters with "gt" operator', () => {
        ...
        expect(result).toEqual([{ id: 2, value: 20 }, { id: 3, value: 30 }]);
    });
    ...
    it('filters with "in" operator', () => {
        ...
        expect(result).toEqual([{ id: 1, value: 10 }, { id: 3, value: 30 }]);
    });
