...
| toggle             | No       | <code>function</code> | No       | <code>() => any</code>                                                                                    | <code>() => { isOpen = visibleState !== undefined ? visibleState : !isOpen; }</code>                        | @deprecated use actions.toggle                                |
| actions            | No       | <code>const</code>    | No       | <code>{ toggle: (visibleState) => { isOpen = visibleState !== undefined ? visibleState : !isOpen; } }</code> | <code>{ toggle: (visibleState) => { isOpen = visibleState !== undefined ? visibleState : !isOpen; } }</code> | should be used                                                |
