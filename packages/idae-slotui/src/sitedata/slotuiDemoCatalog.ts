...
import  Alert from '$lib/base/alert/Alert.demo.svelte';; export const slotuiDemoCatalog = {stylesheet:{component:StyleSheet,name:"StyleSheet",code:"stylesheet",group:"utils",root:"stylesheet"},
...
marquee:{component:Marquee,name:"Marquee",code:"marquee",group:"ui",root:"marquee"},
...
slotyuisheet:{component:SlotyuiSheet,name:"SlotyuiSheet",code:"slotyuisheet",group:"styles",root:"slotuisheet"},
...
textfield:{component:TextField,name:"TextField",code:"textfield",group:"controls",root:"textfield"},
switch:{component:Switch,name:"Switch",code:"switch",group:"controls",root:"switch"},
stepper:{component:Stepper,name:"Stepper",code:"stepper",group:"controls",root:"stepper"},
slider:{component:Slider,name:"Slider",code:"slider",group:"controls",root:"slider"},
...
alert:{component:Alert,name:"Alert",code:"alert",group:"base",root:"alert"},} as const