...
## Synchronization with AGENTS.md (English)

**At every major change in architecture, conventions, or workflows, you must update the root `AGENTS.md` file (create it if it does not exist).**

This file is a quick reference for AI agents and must always be kept in sync with these Copilot instructions.
