...
# Skill: Read idae-mongo README

## Description
This skill allows you to access the full documentation of the idae-mongo package by using the CLI get-readme command. It is designed for use by AI agents, automation scripts, or any user who wants to quickly fetch the official package documentation.
...
- Answering questions about the idae-mongo API or usage patterns
