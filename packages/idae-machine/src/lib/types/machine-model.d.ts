...
export declare function indexFromKeyPath(keyPath: string): string;
...
export type { Where, Operator, OperatorType, SupportedOperator, ResultSet, ResultsetOptions, DataOpGroupByOptions, DotPath, } from '@medyll/qoolie';
//# sourceMappingURL=machine-model.d.ts.map