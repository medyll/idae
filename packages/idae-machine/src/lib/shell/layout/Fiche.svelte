...
<fiche-component>
    <fiche-header>
        <toolbar-component>
            <button onclick={()=> machine.framer.loadFrame('synthesis', collection, collectionId)}>synthese</button>
            <button onclick={()=> machine.framer.loadInDialog( 'fiche.update', collection, collectionId)}>synthese</button>
        </toolbar-component>
    </fiche-header>
    <fiche-zone>
