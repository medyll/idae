...
export const testScheme = {
	...
	customer: {
		keyPath: '++id',
		model: {},
		ts: {} as { id: string; first_name: string; last_name: string; email: string; phone?: string; drivers_license?: string; created_at?: Date },
		template: {
			index: 'id',
	...
	rental: {
		keyPath: '++id',
		model: {},
		ts: {} as { id: string; vehicleId: string; customerId: string; start_date: Date; end_date?: Date; price_per_day: number; total_price?: number; status: 'booked' | 'active' | 'completed' | 'cancelled' },
		template: {
			index: 'id',
	...
	location_office: {
		keyPath: '++id',
		model: {},
		ts: {} as { id: string; code: string; address: string; city: string; country: string; phone?: string },
		template: {
			index: 'id',
	...
	maintenance: {
		keyPath: '++id',
		model: {},
		ts: {} as { id: string; vehicleId: string; date: Date; type: string; cost?: number; notes?: string },
		template: {
			index: 'id',
