...
export class MachineSchemeFieldValues<T extends Record<string, unknown>> {
	 ...
	 */
	constructor(collection: TplCollectionName, data: T, collectionValues?: MachineSchemeValues<T>) {
		this.#collection = collection;
		this.#collectionValues = collectionValues ?? new MachineSchemeValues(collection, machine.logic);
		this.#data = data;
	}
