...
console.log(`[0/3] Clearing engine collections in ${org}_machine_app`);
...
console.log(`[2/4] Deploying engine model (self-registering meta collections)`);
await deployModel(buildEngineModel(), { org, mongoUri });

console.log(`[3/4] Deploying user model (demoScheme)`);
