...
export const demoScheme: MachineModel = {
	...
	vehicle_acquisition: {
		...
		fields: {
			...
			supplier:         field('fk-supplier.code',  { required: true }),
	...
	pricing_rule: {
		...
		fields: {
			id:            field('id',                { readonly: true }),
			category:      field('fk-category.code',  { required: true }),
	...
	damage_report: {
		...
		fields: {
			id:                  field('id',              { readonly: true }),
			rental:              field('fk-rental.code',  { required: true }),
			vehicle:             field('fk-vehicle.code', { required: true }),
	...
	sale_task: {
		...
		fields: {
			id:           field('id',               { readonly: true }),
			seller:       field('fk-seller.code',   { required: true }),
			lead:         field('fk-lead.code'),
			customer:     field('fk-customer.code'),
...
export const demoSeed = {
	...
	seller: [
		{ id: 1, first_name: 'Thomas',   last_name: 'Bernard',  email: 'tbernard@fleet.demo',  phone: '+33611001001', location_office: 'PAR-01', status: 'active', hire_date: new Date('2022-03-15') },
		{ id: 2, first_name: 'Camille',  last_name: 'Rousseau', email: 'crousseau@fleet.demo', phone: '+33622002002', location_office: 'PAR-01', status: 'active', hire_date: new Date('2023-07-01') },
		{ id: 3, first_name: 'Antoine',  last_name: 'Leblanc',  email: 'aleblanc@fleet.demo',  phone: '+33633003003', location_office: 'LYO-01', status: 'active', hire_date: new Date('2021-11-20') },
		{ id: 4, first_name: 'Nathalie', last_name: 'Simon',    email: 'nsimon@fleet.demo',    phone: '+33644004004', location_office: 'PAR-02', status: 'active', hire_date: new Date('2024-01-08') },
	],

	vehicle: [
		{ id: 1,  license_plate: 'AA-111-BB', model: 'Clio V',       brand: 'Renault',  year: 2022, color: 'Blanc',    fuel_type: 'essence',  category: 'compact',  location_office: 'PAR-01', status: 'available', mileage: 28500 },
		{ id: 2,  license_plate: 'CC-222-DD', model: '208',           brand: 'Peugeot',  year: 2021, color: 'Gris',     fuel_type: 'diesel',   category: 'compact',  location_office: 'PAR-01', status: 'rented',    mileage: 45200 },
		{ id: 3,  license_plate: 'EE-333-FF', model: 'Captur',        brand: 'Renault',  year: 2023, color: 'Bleu',     fuel_type: 'hybride',  category: 'suv',      location_office: 'PAR-02', status: 'available', mileage: 11800 },
		{ id: 4,  license_plate: 'GG-444-HH', model: 'Classe E',      brand: 'Mercedes', year: 2023, color: 'Noir',     fuel_type: 'diesel',   category: 'lux',      location_office: 'PAR-01', status: 'available', mileage: 9300  },
		{ id: 5,  license_plate: 'II-555-JJ', model: 'Model 3',       brand: 'Tesla',    year: 2023, color: 'Blanc',    fuel_type: 'électrique',category: 'electric', location_office: 'PAR-01', status: 'available', mileage: 16200 },
		{ id: 6,  license_plate: 'KK-666-LL', model: 'Berlingo',      brand: 'Citroën',  year: 2022, color: 'Gris',     fuel_type: 'diesel',   category: 'utility',  location_office: 'LYO-01', status: 'maintenance',mileage:72000 },
		{ id: 7,  license_plate: 'MM-777-NN', model: 'Atto 3',        brand: 'BYD',      year: 2024, color: 'Vert',     fuel_type: 'électrique',category: 'electric', location_office: 'PAR-02', status: 'available', mileage: 3200  },
		{ id: 8,  license_plate: 'OO-888-PP', model: 'Clio V',        brand: 'Renault',  year: 2022, color: 'Rouge',    fuel_type: 'essence',  category: 'compact',  location_office: 'MRS-01', status: 'available', mileage: 34100 },
		{ id: 9,  license_plate: 'QQ-999-RR', model: '3008',          brand: 'Peugeot',  year: 2023, color: 'Gris',     fuel_type: 'hybride',  category: 'suv',      location_office: 'LYO-01', status: 'rented',    mileage: 22400 },
		{ id: 10, license_plate: 'SS-000-TT', model: 'Classe S',      brand: 'Mercedes', year: 2024, color: 'Noir',     fuel_type: 'hybride',  category: 'lux',      location_office: 'PAR-01', status: 'available', mileage: 5100  },
	],

	vehicle_acquisition: [
		{ id: 1, vehicle: '1',  supplier: 'REN-FR',  acquisition_date: new Date('2022-01-10'), purchase_price: 18500, invoice_ref: 'REN-2022-0042', warranty_months: 24 },
		{ id: 2, vehicle: '2',  supplier: 'PSA-IDF', acquisition_date: new Date('2021-06-15'), purchase_price: 16200, invoice_ref: 'PSA-2021-0887', warranty_months: 24 },
		{ id: 3, vehicle: '3',  supplier: 'REN-FR',  acquisition_date: new Date('2023-02-20'), purchase_price: 24800, invoice_ref: 'REN-2023-0115', warranty_months: 36 },
		{ id: 4, vehicle: '4',  supplier: 'AUT-EU',  acquisition_date: new Date('2023-04-05'), purchase_price: 52000, invoice_ref: 'AUT-2023-0033', warranty_months: 12, notes: 'Véhicule démonstration' },
		{ id: 5, vehicle: '5',  supplier: 'AUT-EU',  acquisition_date: new Date('2023-05-18'), purchase_price: 38500, invoice_ref: 'AUT-2023-0071', warranty_months: 48 },
		{ id: 6, vehicle: '7',  supplier: 'BYD-FR',  acquisition_date: new Date('2024-01-08'), purchase_price: 31200, invoice_ref: 'BYD-2024-0009', warranty_months: 60 },
		{ id: 7, vehicle: '10', supplier: 'AUT-EU',  acquisition_date: new Date('2024-03-01'), purchase_price: 89000, invoice_ref: 'AUT-2024-0012', warranty_months: 24 },
	],
	...
	pricing_rule: [
		{ id: 1, category: 'compact',  season_code: 'standard', price_per_day: 35,  min_days: 1,  discount_pct: 0,  valid_from: new Date('2026-01-01'), valid_until: new Date('2026-12-31') },
		{ id: 2, category: 'compact',  season_code: 'summer',   price_per_day: 45,  min_days: 3,  discount_pct: 0,  valid_from: new Date('2026-06-15'), valid_until: new Date('2026-09-15') },
		{ id: 3, category: 'suv',      season_code: 'standard', price_per_day: 65,  min_days: 1,  discount_pct: 0  },
		{ id: 4, category: 'suv',      season_code: 'summer',   price_per_day: 85,  min_days: 3,  discount_pct: 5  },
		{ id: 5, category: 'lux',      season_code: 'standard', price_per_day: 120, min_days: 2,  discount_pct: 0  },
		{ id: 6, category: 'lux',      season_code: 'weekend',  price_per_day: 150, min_days: 2,  discount_pct: 0  },
		{ id: 7, category: 'electric', season_code: 'standard', price_per_day: 75,  min_days: 1,  discount_pct: 10, valid_from: new Date('2026-01-01') },
		{ id: 8, category: 'compact',  season_code: 'week',     price_per_day: 28,  min_days: 7,  discount_pct: 20 },
	],
