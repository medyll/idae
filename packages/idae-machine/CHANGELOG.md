...
- - feat(Implement): default value factories and associated tests for SchemeField ([7f91a63](https://github.com/medyll/idae/commit/7f91a639f31b916480faeaf13f34ce1de4864e13)) - 2026-01-22 by @medyll
  - feat(Add): CreateOnly component for collection creation and integrate CollectionList in the demo page ([437481e](https://github.com/medyll/idae/commit/437481e98c9f17d9231e27c91674d271d788d585)) - 2026-01-22 by @medyll
  - feat(Add): MachineFieldType enum and class for field type management ([4b715e5](https://github.com/medyll/idae/commit/4b715e537ad3dbd83ebbdca9d6b34113717d1371)) - 2026-01-20 by @medyll
  - refactor(Update): CreateUpdate component to use $derived for reactive form fields and clean up +page.svelte ([4d9a851](https://github.com/medyll/idae/commit/4d9a85175b8b82df8036969b6a7de91ae37c0e50)) - 2026-01-20 by @medyll
  - feat(Enhance): schema management with new tests for MachineDb and MachineScheme integration ([fdcd64d](https://github.com/medyll/idae/commit/fdcd64dee5be6534e3d024cf59f863a71e5d8a33)) - 2026-01-20 by @medyll
  - test(add): unit tests for Machine class functionality and initialization ([f563529](https://github.com/medyll/idae/commit/f563529f6974744b8bfbc2b4e77e5a8beaf32696)) - 2026-01-20 by @medyll
  - refactor(clean): up README and dbSchema by removing outdated sections and unused imports ([38abf60](https://github.com/medyll/idae/commit/38abf600af8b580608e6f65dd75a00e8a4c7ebf0)) - 2026-01-20 by @medyll
  - feat(Implement): MachineScheme and related classes for schema management and validation ([7560122](https://github.com/medyll/idae/commit/75601223051168b94a418eeebd5be99d5a6754b5)) - 2026-01-20 by @medyll
    - Added MachineErrorValidation class for custom validation errors.
    - Introduced MachineScheme class to manage collection schemas and field utilities.
    - Created MachineSchemeField class for parsing individual fields.
    - Developed MachineSchemeFieldForge for advanced metadata and formatting of fields.
    - Implemented MachineSchemeFieldValues for introspecting and formatting field values.
    - Added MachineSchemeValidate for field validation utilities.
    - Enhanced MachineSchemeValues for displaying and formatting field values.
    - Updated MachineDb to utilize MachineScheme for collection management.
    - Refactored MachineParserForge for improved field parsing.
    - Modified UI components to integrate new schema management features.
  - Refactor IDb classes for improved structure and clarity ([ebacf3f](https://github.com/medyll/idae/commit/ebacf3fbefc3058b620b210360e8ad22cf9d248d)) - 2026-01-20 by @medyll
    - Updated IDbCollectionFieldForge to enhance metadata handling and formatting for collection fields.
    - Refined IDbCollectionFieldValues to streamline field introspection and formatting utilities.
    - Revised IDbCollectionValues to improve field value display and introspection methods.
    - Introduced MachineParserForge for better parsing and construction of database field definitions.
    - Enhanced IDbFormValidate and IDbValidationError for clearer validation error handling.
    - Removed deprecated methods and unnecessary types from MachineDb.
    - Updated UI components to utilize new logic structure for collections and reverse foreign keys.
  - refactor(update): IDbCollection and related classes to use MachineDb instance, streamline field parsing and template access ([3194e60](https://github.com/medyll/idae/commit/3194e60a7d4668f5a8f7b413615f7c5f205918fc)) - 2026-01-19 by @medyll
  - feat(add): test scheme and refactor machine logic ([c640742](https://github.com/medyll/idae/commit/c640742976d8458dcbc5dc3f83f604143b8c4aeb)) - 2026-01-19 by @medyll
    - Introduced a new test scheme in `testScheme.ts` for better data modeling.
    - Refactored `CreateUpdate.svelte` to utilize the new machine logic and improve data handling.
    - Updated `CrudZone.svelte` and other UI components to align with the new structure.
    - Enhanced error handling in `IDbError.ts` for better debugging.
    - Improved the `MachineDb` class to support the new test scheme and streamline collection parsing.
    - Removed deprecated methods and cleaned up imports across various components.
    - Updated the main page to initialize the machine with the new test scheme and simplified CRUD operations.
  - feat(implement): new UI components for collection management and enhance error handling with detailed documentation ([5cd6e18](https://github.com/medyll/idae/commit/5cd6e182e2e9d69f865649cb09e310670a27facb)) - 2026-01-16 by @medyll
  - refactor(update): import paths for IDbCollectionFieldForge and IDbFormValidate; expose MachineForge class ([5f1ce10](https://github.com/medyll/idae/commit/5f1ce1071491c8188b653c91b8a3fcb3b7c7ee75)) - 2026-01-16 by @medyll
  - refactor(rename): constructor parameter for clarity in IDbCollection ([4dddea1](https://github.com/medyll/idae/commit/4dddea1f07c569594272903b40517e1319a80dfb)) - 2026-01-16 by @medyll
  - refactor(update): IDbBase and IDbCollection methods for improved clarity and consistency ([ca773fe](https://github.com/medyll/idae/commit/ca773fe2543235219cee04ff2b3853350bece156)) - 2026-01-15 by @medyll
  - Refactor IDbBase and Machine classes; add comprehensive tests for IDbBase functionality ([ee21667](https://github.com/medyll/idae/commit/ee216673ae7c9d6646662f753821c6db4717b9e5)) - 2026-01-15 by @medyll
    - Updated imports in machine.spec.ts and machine.ts to reflect new structure.
    - Renamed \_collections to \_idbbase in Machine class for clarity.
    - Introduced IDbBase class for schema introspection and collection management.
    - Added tests for IDbBase methods including collection retrieval and field validation.
    - Removed outdated page.svelte.test.ts file.
    - Updated pnpm-lock.yaml to include postcss version 8.5.6.
  ...
  - refactor(replace): IDbCollections with IDbBase across multiple files for consistency ([ad586f0](https://github.com/medyll/idae/commit/ad586f0568308bca4e739dc9da59805b4fd54bf6)) - 2026-01-15 by @medyll
  ...
  - fix(add): console log for changeset file creation in generate-changeset script ([0a0e3a1](https://github.com/medyll/idae/commit/0a0e3a1ebaf145d8338ffa84883853657fd45cb1)) - 2026-01-14 by @medyll
  ...
  - fix(add): comment to clarify context retrieval in FieldValue component ([e98ab5d](https://github.com/medyll/idae/commit/e98ab5df1ce3363875488ff3ea453fa50b5aebdb)) - 2026-01-14 by @medyll
  ...
  - Created .prettierrc.cjs configuration file in packages/idae-machine.
    ...
    packages/idae-machine/.prettierrc
    packages/idae-machine/.prettierrc.cjs
    packages/idae-machine/package.json
  - feat(refactor): machine initialization and enhance IDbCollections with shared instances; update README and tests ([2347d63](https://github.com/medyll/idae/commit/2347d63f1b658f47aedb65169af6f22c88e470e1)) - 2026-01-14 by @medyll
  - feat(enhance): README with robustness and testing details; add test plan for Machine class; refactor dbFields and remove obsolete tests ([bca9a77](https://github.com/medyll/idae/commit/bca9a7712a038e27b8212e3496b996c8e6e31c1b)) - 2026-01-13 by @medyll
  ...
  - fix(update): import paths to include file extensions for consistency ([fd88008](https://github.com/medyll/idae/commit/fd88008be4028aeeb2179637d3952702d2b01787)) - 2026-01-13 by @medyll
...
- Updated dependencies
  - @medyll/idae-idbql@0.184.0
  - @medyll/idae-slotui-svelte@8.0.0
...
- Updated dependencies
- Updated dependencies
  - @medyll/idae-idbql@0.183.0
  - @medyll/idae-slotui-svelte@7.0.0
...
- Updated dependencies
- Updated dependencies
  - @medyll/idae-idbql@0.182.0
  - @medyll/idae-slotui-svelte@6.0.0
...
- Updated dependencies
- Updated dependencies
  - @medyll/idae-idbql@0.181.0
  - @medyll/idae-slotui-svelte@5.0.0
...
- Updated dependencies
- Updated dependencies
  - @medyll/idae-idbql@0.180.0
  - @medyll/idae-slotui-svelte@4.0.0
...
- Updated dependencies
  ...
  - @medyll/idae-slotui-svelte@3.0.0
...
- Updated dependencies
  ...
  - @medyll/idae-slotui-svelte@2.0.0
...
- Updated dependencies
- Updated dependencies
  - @medyll/idae-idbql@0.177.0
  - @medyll/idae-slotui-svelte@1.0.0
