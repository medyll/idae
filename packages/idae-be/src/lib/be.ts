...
export class Be {
	...
	*/
	...
	if (this.isWhat !== 'element') return this;

	const sourceEl = typeof sourceElement === 'string' 
		? document.querySelector(sourceElement) 
		: sourceElement;

	if (!sourceEl) return this;

	const sourceRect = sourceEl.getBoundingClientRect();
	const targetRect = (this.node as HTMLElement).getBoundingClientRect();
	...
	*/
	...
	const selfRect = (this.node as HTMLElement).getBoundingClientRect();
