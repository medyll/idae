---
name: idae-query-readme
package: '@medyll/idae-query'
description: Skill to dynamically retrieve the documentation (README.md) of the idae-query package via the standardized CLI. idae-query is a flexible query library for TypeScript/JavaScript, supporting chainable result sets, sorting, grouping, and dot-path resolution. Useful for AI agents, automation scripts, or users needing up-to-date package docs.
---
