...
- feat(Introduce): Prettier configuration for consistent code formatting across packages ([49e0803](https://github.com/medyll/idae/commit/49e08031861ced2fc031e6273dcd29458110fc52)) - 2026-01-18 by @medyll

- feat(Add): detailed descriptions to package.json files for better clarity and documentation ([a9fe159](https://github.com/medyll/idae/commit/a9fe15911480a46ddc261504fa4bda586adae710)) - 2026-01-18 by @medyll

- feat(update): auto exports in multiple index files to include new components and services ([09dcc7b](https://github.com/medyll/idae/commit/09dcc7b79da110de3ff307edaf92dd059e9ba777)) - 2026-01-17 by @medyll
...
- feat(update): package dependencies to use workspace:* and add verification script for internal dependencies ([c8cd562](https://github.com/medyll/idae/commit/c8cd562ddec3d65308f0764b9bbf1884e9c2794e)) - 2026-01-12 by @medyll
...
- feat(idae-model): ajouter des composants CRUD et types pour la gestion des collections ([274178f](https://github.com/medyll/idae/commit/274178fd82dcb3f47b2963b891540054aea259f2)) - 2025-03-08 by @medyll
...
- chore(idae-main): chore ([e866bad](https://github.com/medyll/idae/commit/e866bad4adce99835af1c03ab8ee4eb1d12dae55)) - 2025-03-03 by @medyll
...
- chore(idae-socket): ajouter l'export de fakeHttpPost depuis le répertoire fakeZone ([48d157c](https://github.com/medyll/idae/commit/48d157cd8f5926ff92384829911f1b880b825f05)) - 2025-03-02 by @medyll

- chore(idae-socket): Update fakeHttpPost import in index.ts ([51378bb](https://github.com/medyll/idae/commit/51378bb26f1d3285e3dcedfa7b777b530ce04553)) - 2024-08-19 by @medyll

- chore(Update): dependencies and fix CSS loading and breakpoints ([c2fa789](https://github.com/medyll/idae/commit/c2fa789605729a63825da8b5d2c5b9404740ac3f)) - 2024-08-17 by @medyll

- feat(idae-socket): Add server utils and routes exports ([9f05c5f](https://github.com/medyll/idae/commit/9f05c5f30ff8defb41e96261e490cb7ad0912cde)) - 2024-08-15 by @medyll
...
- chore(idae-socket): added type module du package ([796149c](https://github.com/medyll/idae/commit/796149ccec3bb09842ddd2d197701f7e8a95f320)) - 2024-07-13 by @medyll
...
- chore(chore):  ([86eefed](https://github.com/medyll/idae/commit/86eefed02c650076cc131ceede7a9c34dd51079c)) - 2024-07-11 by @medyll
...
- chore(update): idae-socket ([a956a7b](https://github.com/medyll/idae/commit/a956a7b40747626883c894d295ee4057c5e0ba49)) - 2024-07-10 by @medyll

- chore(idae-socket): 1st integration in monorepo ([7aa4219](https://github.com/medyll/idae/commit/7aa4219a6e7a2685ab1f4f8f19413b0375e7cef0)) - 2024-07-10 by @medyll
